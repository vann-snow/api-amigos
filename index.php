              ...
              <div class="col-lg-8 mb-4 order-0">
                <div class="card">
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        <h5 class="card-title text-primary">With the new day comes new strength and new thoughts. 🎉</h5>
                        <p class="mb-4">
                          As you start your day, think about what you want to achieve and what you need to do to achieve it.
                        </p>
                      </div>
                    </div>
